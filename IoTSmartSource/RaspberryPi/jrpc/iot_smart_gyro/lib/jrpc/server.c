...
cJSON *discover(jrpc_context_t *ctx, cJSON *params, cJSON *id) {
  ...
  //Gyro_X
	  ...
	  cJSON_AddStringToObject(sensor, "id", GYRO_X0);
	  cJSON_AddStringToObject(sensor, "type", "number");
	  cJSON_AddStringToObject(sensor, "name", "gyroX0");
	  cJSON_AddItemToArray(sensors, sensor);
 
  //Gyro_Y
	  sensor = cJSON_CreateObject();
	  cJSON_AddStringToObject(sensor, "id", GYRO_Y0);
	  cJSON_AddStringToObject(sensor, "type", "number");
	  cJSON_AddStringToObject(sensor, "name", "gyroY0");
	  cJSON_AddItemToArray(sensors, sensor);

  //Gyro_Z
	  sensor = cJSON_CreateObject();
	  cJSON_AddStringToObject(sensor, "id", GYRO_Z0);
	  cJSON_AddStringToObject(sensor, "type", "number");
	  cJSON_AddStringToObject(sensor, "name", "gyroZ0");
	  cJSON_AddItemToArray(sensors, sensor);
