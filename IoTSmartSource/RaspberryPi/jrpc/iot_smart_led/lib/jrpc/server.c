...
cJSON *discover(jrpc_context_t *ctx, cJSON *params, cJSON *id) {
  ...
  //LED1
	  ...
	  cJSON_AddStringToObject(sensor, "id", LED1);
	  cJSON_AddStringToObject(sensor, "type", "led");
	  cJSON_AddStringToObject(sensor, "name", "led1");
	  cJSON_AddItemToArray(sensors, sensor);
  //LED2
	  sensor = cJSON_CreateObject();
	  cJSON_AddStringToObject(sensor, "id", LED2);
	  cJSON_AddStringToObject(sensor, "type", "led");
	  cJSON_AddStringToObject(sensor, "name", "led2");
	  cJSON_AddItemToArray(sensors, sensor);
